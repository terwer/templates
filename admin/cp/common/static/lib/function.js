...
//=========================================================================================
String.prototype.cutLeft = function (len,endStr) { return CutLeft(this,len,endStr); };
function CutLeft(str, len, endStr)
{
    if (!endStr) endStr = "";
...
//iframe里面弹出对话框并自动关闭
function showTopMsgs(msg, title, msgcss, w, h, t) {
    var cssname = "";
    switch (msgcss) {
        case "Success":
            cssname = "dialog_ok";
...
function showTopTips(msg, title, msgcss) {
    ...
    var content = "<div class='" + cssname + "'>" + msg + "</div>";
    showTopDialog("show_top_tip", content, title, 400, 95, true);
}
...
function PicUpload(formId, uppath, hidvalue, pre) {
    var submitUrl = "/api/UploadApi/Index/?action=AttachFile&UpFilePath=" + uppath + "&IsWater=1&IsThumbnail=1";
    alert(submitUrl);
    $("#" + formId).ajaxSubmit({
        type: "POST",
        cache: false,
...
//MessageBox ThinkWang 2015-04-19
var MessageBox = {
    //成功
    Success: function (msg, okcallback) {
        var d = top.dialog({
            id: "show_top_msg",
            title: "提示",
            content: "<div class='dialog_ok'>" + msg + "</div>",
            width: 400,
            height: 95,
            drag: true,
            lock: true,
    ...
    Warn: function (msg) {
        var d = top.dialog({
            id: "show_top_msg",
            title: "提示",
            content: "<div class='dialog_alert'>" + msg + "</div>",
            width: 400,
            height: 95,
            drag: true,
            lock: true,
    ...
    Error: function (msg) {
        var d = top.dialog({
            id: "show_top_msg",
            title: "提示",
            content: "<div class='dialog_error'>" + msg + "</div>",
            width: 400,
            height: 95,
            drag: true,
            lock: true,
    ...
    Confirm: function (msg, okCallback) {
        var d = top.dialog({
            id: "show_top_msg",
            title: "提示",
            content: "<div class='dialog_confirm'>" + msg + "</div>",
            width: 400,
            height: 95,
            drag: true,
            lock: true,
...
//修改密码 ThinkWang 2015-05-19
var changePassword = function () {
    showTopContentWindow("account_changepassword", "/Apps/Account/Admin/ChangePassword", "修改密码", 600, 350);
}